...
public class HotelSystemDemo {
    public static void run() {
        HotelSystem hotelManagementSystem = HotelSystem.getInstance();
        ...
        Reservation reservation1 = hotelManagementSystem.booking(guest1, room1, checkInDate, checkOutDate);
        ...
        hotelManagementSystem.cancelBooking(reservation1.getId());
